...
這是一個只有 Skills、不綁特定帳號或付費服務的 Codex Plugin。它把單集 Podcast 的製作流程整理成：音訊與單集封面製作 → 創作者完整試聽音訊並目視核准封面 → 長影片與短影片 → 媒體 QA → 上傳計畫預覽 → 核准後排程發布 → 線上結果驗證。

最重要的硬性規則有兩個：

1. 使用者沒有明確確認「已聽完並接受匯出的 Podcast master」以及「已看過並接受指定的單集封面」以前，不能開始製作長影片或短影片。
